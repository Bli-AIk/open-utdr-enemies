...
> **维护者注：** 身体精灵 `spr_finalfroggit_body`（51×25）在 GameMaker 中的 origin 设置为 (25, 25)，即精灵底部中心。因此 `yscale` 变化时，身体以底边为锚点向上拉伸/收缩——视觉效果是"腿部在底部固定，身体呼吸般起伏"。UTRP 数据中，`pivot` 设为 `(25, 25)` 以匹配此行为。
