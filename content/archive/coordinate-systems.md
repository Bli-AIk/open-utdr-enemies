...
> **社区适用框架**：[UndertaleEngine](https://github.com/TML233/UndertaleEngine)（国内主流 GMS 模板）
...
> **社区适用框架**：[UndertaleMakerX](https://github.com/Yanxiyimengya/UndertaleMakerX)（基于 Godot 4，使用 JavaScript 作为脚本层）
...
> **社区适用框架**：[Kristal](https://github.com/KristalTeam/Kristal)（Deltarune 主流框架）、[SoulEngine](https://github.com/AnskiyyRenew/love2d-undertale-template)（新兴 Undertale 模板）
...
> **社区适用框架**：[Create Your Frisk](https://github.com/RhenaudTheLukark/CreateYourFrisk)（CYF，国外老牌 Undertale 战斗框架）、[Create Your Kris](https://github.com/RhenaudTheLukark/CreateYourKris)（CYK，CYF 的 Deltarune 改版）
...
> **社区适用框架**：[SoupRune](https://github.com/SoupRune/SoupRune)（基于 Bevy 的 UT/DR 全功能框架）
